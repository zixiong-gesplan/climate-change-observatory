            ...
            <div class="flex flex-col lg:flex-row items-center gap-10">
                <div class="lg:w-1/2">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mt-8">
                        ...
                        <x-Governance.MiniCard
                            value="+13"
                            label="Indicadores de cambio climático"
                        />
                    </div>
                </div>
                <div class="lg:w-1/2">
            ...
            <div class="flex flex-col-reverse lg:flex-row items-center gap-10">
                <div class="lg:w-1/2">
                    ...
                    <div class="flex flex-col gap-5 mt-8">
                        <x-Governance.HoverItem
                            title="Energía Solar"
                            subtitle="Proyectos de energía solar a gran escala"
                        />
                        <x-Governance.HoverItem
                            title="Energía Eólica"
                            subtitle="Parques eólicos terrestres y marinos"
                        />
                        <x-Governance.HoverItem
                            title="Reforestación"
                            subtitle="Iniciativas de plantación de árboles"
                        />
                    </div>
                </div>
                <div class="lg:w-1/2">
            ...
            <div class="flex flex-col lg:flex-row items-center gap-10">
                <div class="lg:w-1/2">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
                        ...
                        <x-Governance.Link
                            href="#"
                            label="Base de Datos Climáticos"
                        >
                            <svg class="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                        ...
                        <x-Governance.Link
                            href="#"
                            label="Calculadora de Huella de Carbono"
                        >
                            <svg class="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
