    ...
    <div class="container px-4 md:px-6 relative z-10 justify-center m-auto">
        ...
        <div class="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
            <x-understand.card parallax=0.05>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-thermometer-sun h-12 w-12 text-orange-500">
                    <path d="M12 9a4 4 0 0 0-2 7.5"></path><path d="M12 3v2"></path><path d="m6.6 18.4-1.4 1.4"></path><path d="M20 4v10.54a4 4 0 1 1-4 0V4a2 2 0 0 1 4 0Z"></path><path d="M4 13H2"></path><path d="M6.34 7.34 4.93 5.93"></path>
                </svg>
                <h3 class="text-xl font-bold">Aumento de Temperatura</h3>
                <p class="text-gray-600">
                    La temperatura global está aumentando a un ritmo alarmante, con consecuencias para los ecosistemas y la vida humana.
                </p>
            </x-understand.card>
            <x-understand.card parallax=-0.05>
            ...
            <x-understand.card parallax=0.05>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-wind h-12 w-12 text-gray-500"><path d="M17.7 7.7a2.5 2.5 0 1 1 1.8 4.3H2"></path><path d="M9.6 4.6A2 2 0 1 1 11 8H2"></path><path d="M12.6 19.4A2 2 0 1 0 14 16H2"></path></svg>
                <h3 class="text-xl font-bold">Eventos Climáticos Extremos</h3>
                <p class="text-gray-600">
                    Aumento en la frecuencia e intensidad de tormentas, huracanes, olas de calor y otros fenómenos meteorológicos extremos.
                </p>
            </x-understand.card>
            <x-understand.card parallax=-0.05>
